...
const Home = () => {
  ...
  const handleInstallClick = async () => {
    if (!deferredPrompt) {
      showAlert('To install the app on this device, tap Share and select "Add to Home Screen" (or equivalent option in your browser).');
      return;
    }
        ...
        <div className="lp-col lp-col-center" style={{ minWidth: 0, width: '100%' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap' }}>
            <button 
              ...
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', whiteSpace: 'nowrap', height: '60px' }}
            >
            ...
            <a 
              ...
              className="lp-cta" 
              style={{ background: '#24292e', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', textDecoration: 'none', boxShadow: '0 8px 24px rgba(36, 41, 46, 0.4)', whiteSpace: 'nowrap', height: '60px' }}
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" stroke="none" style={{ flexShrink: 0 }}>
              ...
              <button 
                ...
                className="lp-cta" 
                style={{ background: '#f25c05', color: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', border: 'none', cursor: 'pointer', boxShadow: '0 8px 24px rgba(242, 92, 5, 0.4)', whiteSpace: 'nowrap', height: '60px' }}
              >
