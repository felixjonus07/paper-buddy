...
import { Search, LogOut, IndianRupee, Clock, Download, TrendingUp, PlusCircle, X, CheckCircle, AlertCircle, FileText } from 'lucide-react';
    ...
    <div className="app-container dashboard-layout">
      ...
      <div className="sidebar">
        <div className="sidebar-header" style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem', marginBottom: '2rem', borderBottom: '1px solid var(--text-light)' }}>
          <div style={{ width: '50px', height: '50px', background: 'var(--overlay-bg)', backdropFilter: 'blur(10px)', border: '1px solid var(--border)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div className="dashboard-content">
        <div className="dashboard-header" style={{ backgroundColor: 'var(--clay-base)', padding: '1rem 2rem', borderRadius: '50px', boxShadow: 'var(--clay-outer)' }}>
          ...
          {activeTab === 'log' && (
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem' }}>
                <NeoCard style={{ background: 'linear-gradient(135deg, var(--primary) 0%, #f97316 100%)', color: '#fff' }}>
                  <p style={{ margin: 0, fontSize: '0.85rem', opacity: 0.85 }}>Total Collected Today</p>
                  <h2 style={{ margin: '0.3rem 0 0 0', fontSize: '2rem', color: '#fff' }}>{fmt(todayTotal)}</h2>
                </NeoCard>
                <NeoCard>
                  <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-light)' }}>Transactions Today</p>
                  <h2 style={{ margin: '0.3rem 0 0 0', color: 'var(--primary)' }}>{todayLog.length}</h2>
                </NeoCard>
              </div>
            ...
            <>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.6rem', marginBottom: '1.5rem' }}>
                  {REPORT_PRESETS.map(p => (
                    <button
                      ...
                      style={{
                        padding: '0.4rem 1rem', borderRadius: '20px', border: '1px solid var(--primary)',
              ...
              {reportData && (
                <>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem' }}>
                    <NeoCard style={{ background: 'linear-gradient(135deg, var(--primary) 0%, #f97316 100%)', color: '#fff' }}>
                      <p style={{ margin: 0, fontSize: '0.85rem', opacity: 0.85 }}>Total Collected</p>
                      <h2 style={{ margin: '0.3rem 0 0 0', fontSize: '2rem', color: '#fff' }}>{fmt(reportData.total)}</h2>
                    </NeoCard>
                    <NeoCard>
                      <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-light)' }}>Total Transactions</p>
                      <h2 style={{ margin: '0.3rem 0 0 0', color: 'var(--primary)' }}>{reportData.count}</h2>
                    </NeoCard>
                  </div>
