...
const { getMyFees, getProfile, updateProfile, getStudentFees, payFee, payNewFee, createPaymentOrder, verifyPayment, phonepeCallback, createFeeRequest, getMyFeeRequests, getFeeTypes, changePassword } = require('../controllers/userController');
